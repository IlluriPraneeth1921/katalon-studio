...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_username (1)'), GlobalVariable.USERNAME)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input_password (1)'), GlobalVariable.PASSWORD)
